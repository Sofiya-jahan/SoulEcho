...
import { Heart, Mail, Lock, Loader2, AlertCircle, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#f9f9f7]">
      ...
      >
        <div className="text-center">
          ...
          <h1 className="serif text-4xl font-light mb-2 tracking-tight">Join SoulEcho</h1>
          <p className="text-[#5A5A40] font-medium tracking-widest uppercase text-xs">Create your account</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-gray-500">
            ...
            <Link to="/login" className="text-[#5A5A40] font-semibold hover:underline">
              Log in
            </Link>
          </p>
        </div>
